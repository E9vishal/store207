...
ActiveRecord::Schema.define(version: 20170923094237) do
  ...
  create_table "spree_delivery_slots", force: :cascade do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.index ["deleted_at"], name: "index_spree_delivery_slots_on_deleted_at", using: :btree
    t.index ["shipping_method_id"], name: "index_spree_delivery_slots_on_shipping_method_id", using: :btree
  end
  ...
  create_table "spree_shipments", force: :cascade do |t|
    ...
    t.index ["delivery_slot_id"], name: "index_spree_shipments_on_delivery_slot_id", using: :btree
